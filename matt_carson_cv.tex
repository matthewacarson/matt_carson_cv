...
\vspace{-7pt}
\begin{itemize}
    \item[] Bachelor of Arts, \textit{With College Honors}
    \begin{itemize}
    \vspace{-7pt}
...
\vspace{-7pt}
\begin{itemize}
    \item[] Associate in Arts, Sociology for Transfer, \textit{With Honors}
    \vspace{-7pt}
    \item[] Associate in Arts, Liberal Arts: Behavioral Science \& Social Science for Transfer, \textit{With Honors}
    \vspace{-7pt}
...
\begin{adjustwidth}{0pt}{\righthandindent}
    \vspace{-7pt}
    \begin{itemize}
        \item[] Associate in Arts, Political Science for Transfer, \textit{With Honors}
        \vspace{-7pt}
