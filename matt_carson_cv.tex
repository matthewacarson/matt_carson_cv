...
\fancypagestyle{firstpagestyle}{
    ...
    \fancyfoot[C]{\thepage{} of \pageref{LastPage}}
    \fancyhead[R]{\href{https://bit.ly/CarsonCV}{Updated: \the\month/\the\day/\the\year}}
}
...
\setboolean{fullVersion}{true} % Set to true or false

\newboolean{includeGPA}
\setboolean{includeGPA}{true} % Set to true or false
...
\bigskip
\ifthenelse{\boolean{fullVersion}}
  % If true
