...
\setlength{\headheight}{25pt} % Adjust headheight as suggested
...
\setmainfont{GeorgiaPro}[
    Path = fonts/,
    Extension = .ttf,  % or .otf depending on your files
    UprightFont = *-Regular,
    BoldFont = *-Bold,
    ItalicFont = *-Italic,
...
\fancypagestyle{firstpagestyle}{
    ...
    % \fancyfoot[L]{\href{https://bit.ly/CarsonCV}{bit.ly/CarsonCV}}
    \fancyhead[L]{\center{\LARGE{\bfseries{Matthew A. Carson}}\\\normalsize{Curriculum Vitae}}}
    \fancyfoot[C]{\thepage{} of \pageref{LastPage}}
    \fancyfoot[L]{\href{https://bit.ly/CarsonCV}{\the\month/\the\day/\the\year}}
}
...
% \centerline{\LARGE\bfseries{Matthew A. Carson}} % \MakeUppercase{}
% \smallskip
...
\begin{itemize}[leftmargin=1em, itemsep=0pt, rightmargin=6em]
    \item[] \href{https://bit.ly/PoliSciSample}{\textit{The Policing of the `Reserve Army': Economic Inequality and Police Killings.}
    \item[] Writing sample: \texttt{https://bit.ly/PoliSciSample}}
...
\begin{itemize}[leftmargin=1em, itemsep=0pt, rightmargin=5em]
    \item[] \href{https://bit.ly/SocSample}{\textit{Construction Union Agreements: Union Organizing in Historical- Comparative Perspective.} 
    \item[] Writing sample: \texttt{https://bit.ly/SocSample}}
